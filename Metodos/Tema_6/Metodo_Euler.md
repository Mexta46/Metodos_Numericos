...
### Ejercicio 5:
Resuelve la ecuación diferencial \( \frac{{dy}}{{dx}} = 2y - x \) con condiciones iniciales \( y(0) = 13 \) en el intervalo \( 0 \leq x \leq 1 \) utilizando el método de Euler con un tamaño de paso \( h = 6 \).
